...
@NamedQueries({
    ...
    @NamedQuery(name = "Enrollment.findByCertificateId", query = "SELECT e FROM Enrollment e WHERE e.certificateId = :certificateId"),
...
public class Enrollment implements Serializable {
    ...
    public void setCertificateUrl(String certificateId) {
